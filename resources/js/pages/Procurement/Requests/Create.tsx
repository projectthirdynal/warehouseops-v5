            ...
            <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="Warehouse, Marketing..."
                />
              </div>
              <div className="space-y-1">
                ...
                <div key={idx} className="grid grid-cols-12 items-end gap-2 rounded-md border p-3">
                      ...
                      onValueChange={(v) => {
                        ...
                        if (type === 'p') {
                          ...
                          updateLine(idx, {
                            ...
                            supply_id: null,
                            unit_price_estimate: p?.cost_price ?? 0,
                          });
                        } else {
                          ...
                          updateLine(idx, {
                            supply_id: Number(id),
                            product_id: null,
                            unit_price_estimate: s?.cost_price ?? 0,
                          });
                        }
                      }}
                    >
                      <SelectTrigger>
                        <SelectValue placeholder="Select product or supply..." />
                      </SelectTrigger>
                      <SelectContent>
                        {products.length > 0 && (
                  ...
                  <div className="col-span-2 space-y-1">
                    ...
                    <Select
                      ...
                      onValueChange={(v) => updateLine(idx, { uom_id: Number(v) })}
                    >
                      <SelectTrigger>
                  ...
                  <div className="col-span-1 space-y-1">
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        updateLine(idx, { quantity_requested: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div className="col-span-2 space-y-1">
                    ...
                    <Input
                      ...
                      min={0}
                      step={0.01}
                      value={line.unit_price_estimate}
                      onChange={(e) =>
                        updateLine(idx, { unit_price_estimate: Number(e.target.value) })
                      }
                    />
                  </div>
                  <div className="col-span-2 space-y-1">
