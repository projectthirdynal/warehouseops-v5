                      ...
                      <TableCell className="text-sm">
                        {it.purchase_order_item?.product
                          ...
                          : it.purchase_order_item?.supply
                            ? <><span className="font-mono">{it.purchase_order_item.supply.sku}</span> — {it.purchase_order_item.supply.name} <span className="ml-2 rounded bg-gray-100 px-1.5 py-0.5 text-[10px] uppercase text-gray-600">Material</span></>
                          : '—'}
