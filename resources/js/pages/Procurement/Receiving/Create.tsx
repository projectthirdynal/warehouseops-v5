    ...
    <AppLayout>
      ...
      <div className="space-y-4 p-4 sm:space-y-6 sm:p-6">
        ...
        <form onSubmit={submit} className="space-y-6">
            ...
            <CardContent className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  placeholder="Delivery driver, ref #, etc."
                />
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base">Lines — record received quantity per item</CardTitle>
            </CardHeader>
            <CardContent className="p-0">
                      ...
                      <TableRow key={it.id}>
                        ...
                        <TableCell className="text-right">
                          <Input
                            ...
                            onChange={(e) =>
                              updateLine(idx, { quantity_rejected: Number(e.target.value) })
                            }
                            className="text-right"
                          />
                        </TableCell>
                        <TableCell>
                          <Select
                            ...
                            onValueChange={(v) =>
                              updateLine(idx, { condition: v as LineState['condition'] })
                            }
                          >
                            <SelectTrigger>
                              <SelectValue />
              ...
              <div className="border-t p-4">
                <Label className="text-xs">
                  Discrepancy notes (shortages, condition issues, etc.)
                </Label>
                <Textarea
                  rows={2}
          ...
          <p className="text-right text-xs text-muted-foreground">
            A draft GRN is created — confirm it on the next page to post stock.
          </p>
        </form>
      </div>
    </AppLayout>
