                      ...
                      <TableRow key={it.id}>
                        <TableCell className="text-sm">
                          {it.product
                            ...
                            : it.supply
                              ? <><span className="font-mono">{it.supply.sku}</span> — {it.supply.name} <span className="ml-2 rounded bg-gray-100 px-1.5 py-0.5 text-[10px] uppercase text-gray-600">Material</span></>
                              : '—'}
                        </TableCell>
