                  ...
                  {invoice.lines.map((line) => (
                    <tr key={line.id} className="border-t">
                      ...
                      <td className="px-4 py-3 text-right">
                        ₱
                        {parseFloat(line.unit_price).toLocaleString('en-PH', {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                      <td className="px-4 py-3 text-right">
                        ₱
                        {parseFloat(line.discount_amount).toLocaleString('en-PH', {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                      <td className="px-4 py-3 text-right">
                        ₱
                        {parseFloat(line.tax_amount).toLocaleString('en-PH', {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                      <td className="px-4 py-3 text-right font-medium">
                        ₱
                        {parseFloat(line.total_ttc).toLocaleString('en-PH', {
                          minimumFractionDigits: 2,
                        })}
                      </td>
                    </tr>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) => setPayData('reference_number', e.target.value)}
                />
              </div>
              <DialogFooter>
                <Button variant="outline" type="button" onClick={() => setShowPayment(false)}>
                  Close
                </Button>
