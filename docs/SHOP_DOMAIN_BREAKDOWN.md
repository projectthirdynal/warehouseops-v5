...
├── Console/
│   └── Commands/
│       └── ValidateFacebookTokens.php
├── CourierCsv/
│   ├── CourierCsvAddressValidator.php
│   ├── CourierCsvCodValidator.php
│   ├── CourierCsvColumn.php
│   ├── CourierCsvCorrectionSuggester.php
│   ├── CourierCsvEncodingChecker.php
│   ├── CourierCsvPhoneValidator.php
│   ├── CourierCsvSchema.php
│   ├── CourierCsvSchemaRegistry.php
│   ├── CourierCsvTemplateBuilder.php
│   ├── CourierCsvTestMode.php
│   ├── CourierCsvUploadVerifier.php
│   ├── CourierCsvValidationAnalytics.php
│   ├── CourierCsvValidationConfig.php
│   ├── CourierCsvValidator.php
│   └── CourierCsvWeightDimensionValidator.php
├── Http/
│   └── Controllers/
...
│   ├── ConversationStatusHistory.php
│   ├── CourierCsvTemplate.php
│   ├── CourierCsvValidationErrorLog.php
│   ├── CourierExportBatch.php
│   ├── CourierExportBatchShare.php
│   ├── CourierExportRow.php
│   ├── CustomerIdentity.php
│   ├── FacebookAccount.php
│   ├── FacebookPage.php
...
│   ├── ShippingRate.php
│   ├── ShopOrderItem.php
│   ├── ShopReplyTemplate.php
│   └── Tag.php
└── Services/
    ├── AddressFormatService.php
    ├── AddressMappingService.php
    ├── AutoAssignmentService.php
    ├── BroadcastCampaignService.php
    ├── CartTemplateSharingService.php
    ├── ConversationArchiveService.php
    ├── ConversationExportService.php
    ...
    ├── CustomerNoteService.php
    ├── CustomerRiskService.php
    ├── CustomerStatsService.php
    ├── CustomerTimelineService.php
    ├── FacebookConnectorService.php
    ├── GamificationService.php
    ├── GeocodingService.php
    ├── MessageTranslationService.php
    ├── MessengerEligibilityService.php
    ├── MetaApiClient.php
    ├── MetaConversationIngestor.php
    ├── PhoneDetectionService.php
    ├── ProductRecommendationService.php
    ├── RichMediaTemplateService.php
    ├── SentimentAnalysisService.php
    ├── SentimentReviewService.php
    ├── ShippingRateService.php
    ├── ShopReportsEnhancementService.php
    └── WebhookEventKeyGenerator.php
```

> **Note:** `AgentProfile` is referenced by the Shop domain (assignment/gamification) but physically lives at `app/Models/AgentProfile.php`, not under `app/Domain/Shop/Models`.
