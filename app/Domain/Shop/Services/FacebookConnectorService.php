...
class FacebookConnectorService
{
    ...
    public function authorizationUrl(?string $state = null): string
    {
        ...
        if (filled(config('services.meta.login_config_id'))) {
            ...
            $parameters['scope'] = implode(',', $this->requestedScopes());
        }
    ...
    /**
     * @return array{id?: string, name?: ?string, first_name?: ?string, last_name?: ?string, profile_pic?: ?string}|null
     */
    public function fetchMessengerProfile(FacebookPage $page, string $psid): ?array
    {
